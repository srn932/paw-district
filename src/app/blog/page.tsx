...
export const metadata=pageMetadata("Pet Care Journal","Practical notes about pet boarding, professional grooming, dog training, puppy care and everyday pet parenting","/blog");
