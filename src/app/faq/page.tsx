...
export const metadata=pageMetadata("Pet Care FAQs","Answers about Paw District appointments, dog and cat grooming, daycare, pet boarding, vaccinations and wellness care","/faq");
