...
export default async function ServicePage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <><SEOJsonLd data={{ "@context": "https://schema.org", "@type": "Service", name: `${service.name} at Paw District`, description: service.description, provider: { "@type": "LocalBusiness", name: "Paw District", url: siteConfig.url }, url: `${siteConfig.url}/services/${service.slug}` }} /><PageHero eyebrow={service.kicker} title={service.headline} copy={service.intro} image={service.image} imagePosition={service.imagePosition} accent={service.color} breadcrumbs={[{ label: service.name }]} />
